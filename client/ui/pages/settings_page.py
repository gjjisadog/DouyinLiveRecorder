...
class SettingsPage(QWidget):
    ...
    def __init__(
        ...
        self.max_file_size_spin = QDoubleSpinBox(self)
    ...
    def _build_recording_group(self) -> QGroupBox:
        ...
        self.max_file_size_spin.setRange(0.1, 1024.0)
        self.max_file_size_spin.setDecimals(1)
        self.max_file_size_spin.setSingleStep(0.5)
        self.max_file_size_spin.setSuffix(" GB")
        ...
        form.addRow("单文件上限", self.max_file_size_spin)
    ...
    def _load_from_viewmodel(self) -> None:
        ...
        self.max_file_size_spin.setValue(config.max_file_size_gb)
    ...
    def _save_settings(self) -> None:
        ...
        config.max_file_size_gb = self.max_file_size_spin.value()
